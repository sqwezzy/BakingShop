...
@Component({
  ...
  templateUrl: './carete-or-update-category.component.html',
  styleUrls: ['./carete-or-update-category.component.scss']
})
export class CareteOrUpdateCategoryComponent implements OnInit {
  form: FormGroup;
  title: string;
  action: string;
  spinner: boolean;
  ...
  constructor(private modal: MatDialog,
              ...
              public modalRef: MatDialogRef<CareteOrUpdateCategoryComponent>,
